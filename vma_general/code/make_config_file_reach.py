...
instruct_clamp = [instruct['clamp']] + [''] * (n_clamp * n_targets - 1)
instruct_general = [instruct['general']] + [''] * (n_general * n_targets - 1)
instruct_wash = [instruct['wash']] + [''] * (n_wash * n_targets - 1)

instruct = np.concatenate((instruct_fam, instruct_base, instruct_clamp,
